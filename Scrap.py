...
async def clear(ctx, amount=10):
    ...
    messages = []
    async for message in client.logs(channel, limit=int(amount)):
...
client.run("NjkzOTIzMDg4NzYwNDM4ODM0.XoFwxg.YjWVR0JbfZhdcWzdfojFmLJ7SlA") 
